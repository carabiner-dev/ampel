...
const file_policy_proto_rawDesc = "" +
	...
	"\bidentity\x18\x03 \x01(\v2\x12.ampel.v1.IdentityR\bidentity\x128\n" +
	...
	"\x03ref\x18\x03 \x01(\v2\x15.ampel.v1.IdentityRefH\x02R\x03ref\x88\x01\x01B\v\n" +
	"\t_sigstoreB\x06\n" +
	"\x04_keyB\x06\n" +
	"\x04_ref\"E\n" +
	"\aControl\x12\x14\n" +
	...
	"\adefault\x18\x04 \x01(\v2\x16.google.protobuf.ValueR\adefault\"=\n" +
	"\x05Error\x12\x18\n" +
	...
	"\n" +
	"predicates\x18\x04 \x01(\v2\x17.ampel.v1.PredicateSpecR\n" +
	"predicates\x126\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x10.ampel.v1.OutputR\x05value:\x028\x01\"=\n" +
	"\rChainedOutput\x12\x16\n" +
	"\x06policy\x18\x01 \x01(\tR\x06policy\x12\x14\n" +
	"\x05tenet\x18\x02 \x01(\tR\x05tenet\"\x90\x01\n" +
	"\x10ChainedPredicate\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x1a\n" +
	"\bselector\x18\x02 \x01(\tR\bselector\x12\x18\n" +
	"\aruntime\x18\x03 \x01(\tR\aruntime\x122\n" +
	"\n" +
	"identities\x18\x05 \x03(\v2\x12.ampel.v1.IdentityR\n" +
	"identities\"&\n" +
	"\n" +
	"Assessment\x12\x18\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05valueB\x87\x01\n" +
	"\fcom.ampel.v1B\vPolicyProtoP\x01Z)github.com/carabiner-dev/ampel/pkg/api/v1\xa2\x02\x03AXX\xaa\x02\bAmpel.V1\xca\x02\bAmpel\\V1\xe2\x02\x14Ampel\\V1\\GPBMetadata\xea\x02\tAmpel::V1b\x06proto3"
