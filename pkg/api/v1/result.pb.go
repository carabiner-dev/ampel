...
const file_result_proto_rawDesc = "" +
	"\n" +
	"\fresult.proto\x12\bampel.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\fpolicy.proto\x1a\fintoto.proto\"\x84\x03\n" +
	"\x06Result\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x129\n" +
	"\n" +
	"date_start\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tdateStart\x125\n" +
	"\bdate_end\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\adateEnd\x12+\n" +
	"\x06policy\x18\x04 \x01(\v2\x13.ampel.v1.PolicyRefR\x06policy\x127\n" +
	"\feval_results\x18\x05 \x03(\v2\x14.ampel.v1.EvalResultR\vevalResults\x12\"\n" +
	"\x04meta\x18\x06 \x01(\v2\x0e.ampel.v1.MetaR\x04meta\x12.\n" +
	"\x05chain\x18\a \x03(\v2\x18.ampel.v1.ChainedSubjectR\x05chain\x126\n" +
	"\asubject\x18\b \x01(\v2\x1c.ampel.v1.ResourceDescriptorR\asubject\"\xb8\x01\n" +
	"\x0eChainedSubject\x124\n" +
	"\x06source\x18\x01 \x01(\v2\x1c.ampel.v1.ResourceDescriptorR\x06source\x12>\n" +
	"\vdestination\x18\x02 \x01(\v2\x1c.ampel.v1.ResourceDescriptorR\vdestination\x120\n" +
	"\x04link\x18\x03 \x01(\v2\x1c.ampel.v1.ChainedSubjectLinkR\x04link\"h\n" +
	"\x12ChainedSubjectLink\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12>\n" +
	"\vattestation\x18\x02 \x01(\v2\x1c.ampel.v1.ResourceDescriptorR\vattestation\"\xaa\x02\n" +
	"\n" +
	"EvalResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12.\n" +
	"\x04date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x04date\x12/\n" +
	"\x06output\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x06output\x126\n" +
	"\n" +
	"statements\x18\x05 \x03(\v2\x16.ampel.v1.StatementRefR\n" +
	"statements\x12%\n" +
	"\x05error\x18\x06 \x01(\v2\x0f.ampel.v1.ErrorR\x05error\x124\n" +
	"\n" +
	"assessment\x18\a \x01(\v2\x14.ampel.v1.AssessmentR\n" +
	"assessment\"b\n" +
	"\fStatementRef\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12>\n" +
	"\vattestation\x18\x02 \x01(\v2\x1c.ampel.v1.ResourceDescriptorR\vattestation\"\xb6\x02\n" +
	"\tResultSet\x12\x0e\n" +
