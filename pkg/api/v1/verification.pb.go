...
const file_verification_proto_rawDesc = "" +
	"\n" +
	"\x12verification.proto\x12\bampel.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\fpolicy.proto\"M\n" +
	"\fVerification\x12=\n" +
	"\tsignature\x18\x01 \x01(\v2\x1f.ampel.v1.SignatureVerificationR\tsignature\"\x97\x01\n" +
	"\x15SignatureVerification\x12.\n" +
	"\x04date\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x04date\x12\x1a\n" +
	"\bverified\x18\x02 \x01(\bR\bverified\x122\n" +
	"\n" +
	"Identities\x18\x03 \x03(\v2\x12.ampel.v1.IdentityR\n" +
	"IdentitiesB\x8d\x01\n" +
	"\fcom.ampel.v1B\x11VerificationProtoP\x01Z)github.com/carabiner-dev/ampel/pkg/api/v1\xa2\x02\x03AXX\xaa\x02\bAmpel.V1\xca\x02\bAmpel\\V1\xe2\x02\x14Ampel\\V1\\GPBMetadata\xea\x02\tAmpel::V1b\x06proto3"
